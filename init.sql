...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='好友申请表';
...
CREATE TABLE `group_member` (
                                ...
                                `updated_at` datetime NOT NULL,
                                PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb4 COMMENT='群成员';
...
CREATE TABLE `message_session_list` (
                                        ...
                                        `topping` tinyint(4) NOT NULL DEFAULT '0' COMMENT '是否置顶',
                                        ...
                                        `online` tinyint(4) NOT NULL DEFAULT '0' COMMENT '在线状态 0不在1在线',
...
) ENGINE=InnoDB AUTO_INCREMENT=122 DEFAULT CHARSET=utf8mb4 COMMENT='消息会话列表';